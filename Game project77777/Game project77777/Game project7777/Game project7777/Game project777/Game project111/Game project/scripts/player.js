...
function Enemy(l, t, k , n, idname /*,b1 , b2 , b3 , b4 */ ) {
    var that = this;
    this.health = 1;
    this.currentDirEn=1;
    this.posl = l;
    ...
    */
    ...
    b => { x:100, y:200, xspeed:1, yspeed:1 };

    this.update = function()
    {
        if(this.coordinatner > b.x kam y )
        {
            this.xspeed = b.xspeed;
            this.yspped = b.yspeed;
        }
    }
                        ...
                        //4-left        
                            ...
                            /* if(that.currentDirEn==4){
                                ...
                                console.log("NEW!!!");
                                    ...
                                    that.d.css({
                                                    //"left":arr.eq(i).position().left + arr.eq(i).width() + 10,
                                                    "background-image": 'url("images/enemyback.png")'
                                                });
                                   // break;
                                   that.d.css({"left":(arr.eq(i).position().left + arr.eq(i).width() + 10)+"px"});

                                   if (Math.abs(that.EN_HOR_CENTER - that.STONE_HOR_CENTER) <= that.WIDTH_DIFFERENCE &&  
                                        Math.abs(that.EN_VER_CENTER - that.STONE_VER_CENTER) <= that.HEIGHT_DIFFERENCE ) 
                                        {
                                            that.d.css({"left":(arr.eq(i).position().left + arr.eq(i).width() + 10)+"px"});
                                           // console.log("DOOONE!!");
                                            that.currentDirEn="down";
                                            console.log(that.currentDirEn);
                                            break;
                                       }
                            }*/
                            

                           /* else if(that.currentDirEn==3){//right3
                            ...
                            else if(that.currentDirEn==2){//top2
                            ...
                            if(that.currentDirEn==1){//bottom4
                                    that.currentDirEn=2;
                                        console.log(that.currentDirEn);
                                        if(that.currentDirEn==2){
                                                that.n=-5;
                                                that.k=0;
                                                    if (Math.abs(that.EN_HOR_CENTER - that.STONE_HOR_CENTER) <= that.WIDTH_DIFFERENCE +10 &&  
                                                         Math.abs(that.EN_VER_CENTER - that.STONE_VER_CENTER) <= that.HEIGHT_DIFFERENCE +10 ) {
                               ...
                               /* console.log(that.currentDirEn);
                                    ...
                                    console.log(that.d.position().left);*/
                            }
